...
class QuyDinh(db.Model):
    ...
    ThoiGianDatVeToiThieu = db.Column(db.Integer, default = 1) #Thoi gian dat ve muon nhat truoc luc chuyen bay khoi hanh
    ...
    def serialize(self):
        return {
            ...
            'thoigianvechuyenbay': self.ThoiGianDatVeToiThieu
        }